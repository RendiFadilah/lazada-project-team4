                    ...
                    <div className="row">
                        ...
                        <form action="">
                                <div className="form-group">
                                    ...
                                    <input type="email" class="form-control" id="email" placeholder="Silahkan masukkan Nomor Telepon Anda Atau Email" />
                                </div>
                                <div className="form-group password">
                                    <label htmlFor="email">Kata Sandi</label>
                                    <input type="email" class="form-control" id="email" placeholder="Mohon isi kata sandi Anda" />
                                </div>

                                <Button type="link" href="/forgetpassword" className="float-right">
                                    Lupa Kata Sandi?
                                </Button>
                            </form>
                        </div>
